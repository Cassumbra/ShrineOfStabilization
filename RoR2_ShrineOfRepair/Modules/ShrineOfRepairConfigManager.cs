...
namespace ShrineOfRepair.Modules
{
    public class ShrineOfRepairConfigManager
    {
        ...
        public void Init(string configPath)
        {
            ...
            MaxUses = mainConfig.Bind("General", "Max Uses", 2, "Amount of times a single shrine can repair before deactivating. Set to 0 for infinite.");
            ...
            PurchaseInteractionGoldBaseCost = allInOneConfig.Bind("Gold", "Shrine Base Cost", 0, "Base cost of the interactable in gold that is used for scaling. Will spawn with this cost at the start of the run.");
            ...
            PickerPanelGoldTier1Cost = perItemConfig.Bind("Per Item Repairs", "Tier 1 cost", 0, "Base cost of tier 1 (white) item repair. By default the cost is equal to the half of normal chest price, rounded down.");
            PickerPanelGoldTier2Cost = perItemConfig.Bind("Per Item Repairs", "Tier 2 cost", 0, "Base cost of tier 2 (green) item repair. By default the cost is equal to the half of large chest price.");
            PickerPanelGoldTier3Cost = perItemConfig.Bind("Per Item Repairs", "Tier 3 cost", 0, "Base cost of tier 3 (red) item repair. By default the cost is equal to the half of legendary chest price.");
            PickerPanelGoldBossCost = perItemConfig.Bind("Per Item Repairs", "Boss cost", 0, "Base cost of boss (yellow) item repair. By default the cost is equal to double tier 2 repair price.");
            PickerPanelGoldLunarCost = perItemConfig.Bind("Per Item Repairs", "Lunar cost", 0, "Base cost of lunar (blue) item repair. By default the cost is equal to the half of large chest price.");
            PickerPanelGoldEquipCost = perItemConfig.Bind("Per Item Repairs", "Equipment cost", 0, "Base cost of equipments (orange) repair. By default the cost is equal to double tier 2 repair price.");
